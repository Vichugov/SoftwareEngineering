...
взаимосвязях. Примерами таких моделей являются водопадная
...
Bootstrap. Также имеются и другие модели, например, ISO 9000-3
...
(Software Capability Evaluation) касается процессов у подрядчиков.
...
производимых на единицу трудозатрат. – “person-effort”), а также,
