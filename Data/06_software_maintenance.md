...
ITIL – IT Infrastructure Library, уделяющей особое внимание
...
даже к бо?льшим проектным затратам именно в силу недостаточно проработанной
...
влияния, идентифицируя все системы и программные продукты, на
...
Запросы на изменения (change requests - CR), иногда упоминаемые как
...
занимает несколько лет, а то и более (5-10-...). Проведение оценки
